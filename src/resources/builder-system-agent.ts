	...
	nodes: [
		{
			...
			prompt: [
				...
				'Return JSON only, with the exact top-level shape {"agent_file": <portable-agent-json>}.',
				...
				'You may author richer public surfaces when requested: params, skills, mcps, plugins, permissions, memory_bindings, runtime_sources, runtime_options, interaction, chat, and orchestrator_agent nodes.',
				...
				'Runtime options may request public controls such as model, reasoning_effort, speed_tier, or personality only when the request calls for them; keep them as portable option hints, not account metadata.',

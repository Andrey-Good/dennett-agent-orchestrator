...
export interface UserChatOptionsRequestPayload {
	...
	text: string
	require_response: boolean
	options: [UserChatOptionsRequestOption, ...UserChatOptionsRequestOption[]]
}

export type UserChatRequestPayload = UserChatTextRequestPayload | UserChatOptionsRequestPayload
...
export type UserChatResponsePayload = UserChatTextResponsePayload | UserChatOptionResponsePayload

export interface RuntimeUserChatRequestEvent {
	kind: 'user_chat_request'
	request_handle: unknown
...
export interface RuntimeAdapterPorts {
	...
	startExecution(request: RuntimeAdapterExecutionRequest): Promise<RuntimeExecutionSession>
	listModels(request?: RuntimeModelCatalogRequest): Promise<RuntimeModelCatalogPage>
	inspectRuntimeEnvironment(): Promise<RuntimeEnvironmentInspectionResult>
	inspectRuntimeSource(source: RuntimeSourceSelection): Promise<RuntimeSourceInspectionResult>
	deliverComment(execution: unknown, text: string): Promise<void>
	deliverUserChatResponse(execution: unknown, response: UserChatResponsePayload): Promise<void>
	cancelExecution(execution: unknown): Promise<void>
}

export type RuntimeAdapter = RuntimeAdapterPorts

        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/GetWorkspace",
            );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/WatchWorkspace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn get_workspace_diff(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWorkspaceDiffRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetWorkspaceDiffResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/GetWorkspaceDiff",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/ApplyFileChanges",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn run_workspace_command(
            &mut self,
            request: impl tonic::IntoRequest<super::RunWorkspaceCommandRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RunWorkspaceCommandResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/RunWorkspaceCommand",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn cancel_workspace_operation(
            &mut self,
            request: impl tonic::IntoRequest<super::CancelWorkspaceOperationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelWorkspaceOperationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/CancelWorkspaceOperation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/CreateCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn restore_checkpoint(
            ...
            tonic::Response<super::RestoreCheckpointResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/RestoreCheckpoint",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn submit_review_action(
            &mut self,
            request: impl tonic::IntoRequest<super::SubmitReviewActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SubmitReviewActionResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.WorkspaceService/SubmitReviewAction",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod workspace_service_server {
    ...
    pub trait WorkspaceService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_workspace(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the WatchWorkspace method.
        type WatchWorkspaceStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WatchWorkspaceResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        ///
        async fn watch_workspace(
            ...
            tonic::Response<Self::WatchWorkspaceStream>,
            tonic::Status,
        >;
        ///
        async fn get_workspace_diff(
            &self,
            request: tonic::Request<super::GetWorkspaceDiffRequest>,
        ) -> std::result::Result<
            tonic::Response<super::GetWorkspaceDiffResponse>,
            tonic::Status,
        >;
        ...
        async fn apply_file_changes(
            &self,
            request: tonic::Request<super::ApplyFileChangesRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ApplyFileChangesResponse>,
            tonic::Status,
        >;
        ...
        async fn run_workspace_command(
            &self,
            request: tonic::Request<super::RunWorkspaceCommandRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RunWorkspaceCommandResponse>,
            tonic::Status,
        >;
        ///
        async fn cancel_workspace_operation(
            &self,
            request: tonic::Request<super::CancelWorkspaceOperationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::CancelWorkspaceOperationResponse>,
            tonic::Status,
        >;
        ...
        async fn submit_review_action(
            &self,
            request: tonic::Request<super::SubmitReviewActionRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SubmitReviewActionResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/dennett.control.v1.WorkspaceService/WatchWorkspace" => {
                    #[allow(non_camel_case_types)]
                    struct WatchWorkspaceSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    ...
                    for WatchWorkspaceSvc<T> {
                        ...
                        type ResponseStream = T::WatchWorkspaceStream;
                        type Future = BoxFuture<
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::watch_workspace(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/dennett.control.v1.WorkspaceService/GetWorkspaceDiff" => {
                    #[allow(non_camel_case_types)]
                    struct GetWorkspaceDiffSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::GetWorkspaceDiffRequest>
                    for GetWorkspaceDiffSvc<T> {
                        type Response = super::GetWorkspaceDiffResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::get_workspace_diff(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetWorkspaceDiffSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.WorkspaceService/ApplyFileChanges" => {
                    #[allow(non_camel_case_types)]
                    struct ApplyFileChangesSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::ApplyFileChangesRequest>
                    for ApplyFileChangesSvc<T> {
                        type Response = super::ApplyFileChangesResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::apply_file_changes(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ApplyFileChangesSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.WorkspaceService/RunWorkspaceCommand" => {
                    #[allow(non_camel_case_types)]
                    struct RunWorkspaceCommandSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::RunWorkspaceCommandRequest>
                    for RunWorkspaceCommandSvc<T> {
                        type Response = super::RunWorkspaceCommandResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::run_workspace_command(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RunWorkspaceCommandSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.WorkspaceService/CancelWorkspaceOperation" => {
                    #[allow(non_camel_case_types)]
                    struct CancelWorkspaceOperationSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::CancelWorkspaceOperationRequest>
                    for CancelWorkspaceOperationSvc<T> {
                        type Response = super::CancelWorkspaceOperationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            request: tonic::Request<
                                super::CancelWorkspaceOperationRequest,
                            >,
                        ) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::cancel_workspace_operation(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = CancelWorkspaceOperationSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.WorkspaceService/CreateCheckpoint" => {
                    #[allow(non_camel_case_types)]
                    struct CreateCheckpointSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    ...
                    for CreateCheckpointSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::create_checkpoint(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/dennett.control.v1.WorkspaceService/RestoreCheckpoint" => {
                    #[allow(non_camel_case_types)]
                    struct RestoreCheckpointSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::RestoreCheckpointRequest>
                    for RestoreCheckpointSvc<T> {
                        type Response = super::RestoreCheckpointResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::restore_checkpoint(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/dennett.control.v1.WorkspaceService/SubmitReviewAction" => {
                    #[allow(non_camel_case_types)]
                    struct SubmitReviewActionSvc<T: WorkspaceService>(pub Arc<T>);
                    impl<
                        T: WorkspaceService,
                    > tonic::server::UnaryService<super::SubmitReviewActionRequest>
                    for SubmitReviewActionSvc<T> {
                        type Response = super::SubmitReviewActionResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as WorkspaceService>::submit_review_action(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SubmitReviewActionSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    pub const SERVICE_NAME: &str = "dennett.control.v1.WorkspaceService";
...
pub mod project_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/CreateProject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.ProjectService", "CreateProject"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/ListProjects",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.ProjectService", "ListProjects"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/GetProject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.ProjectService", "GetProject"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn inspect_project_location(
            &mut self,
            request: impl tonic::IntoRequest<super::InspectProjectLocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InspectProjectLocationResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/InspectProjectLocation",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn register_project(
            &mut self,
            request: impl tonic::IntoRequest<super::RegisterProjectRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RegisterProjectResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/RegisterProject",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn rebind_project_workspace(
            &mut self,
            request: impl tonic::IntoRequest<super::RebindProjectWorkspaceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RebindProjectWorkspaceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/RebindProjectWorkspace",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn set_project_trust(
            &mut self,
            request: impl tonic::IntoRequest<super::SetProjectTrustRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SetProjectTrustResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.ProjectService/SetProjectTrust",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod project_service_server {
    ...
    pub trait ProjectService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn inspect_project_location(
            &self,
            request: tonic::Request<super::InspectProjectLocationRequest>,
        ) -> std::result::Result<
            tonic::Response<super::InspectProjectLocationResponse>,
            tonic::Status,
        >;
        ...
        async fn register_project(
            &self,
            request: tonic::Request<super::RegisterProjectRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RegisterProjectResponse>,
            tonic::Status,
        >;
        ...
        async fn rebind_project_workspace(
            &self,
            request: tonic::Request<super::RebindProjectWorkspaceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RebindProjectWorkspaceResponse>,
            tonic::Status,
        >;
        ...
        async fn set_project_trust(
            &self,
            request: tonic::Request<super::SetProjectTrustRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SetProjectTrustResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/dennett.control.v1.ProjectService/InspectProjectLocation" => {
                    #[allow(non_camel_case_types)]
                    struct InspectProjectLocationSvc<T: ProjectService>(pub Arc<T>);
                    impl<
                        T: ProjectService,
                    > tonic::server::UnaryService<super::InspectProjectLocationRequest>
                    for InspectProjectLocationSvc<T> {
                        type Response = super::InspectProjectLocationResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProjectService>::inspect_project_location(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = InspectProjectLocationSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.ProjectService/RegisterProject" => {
                    ...
                    impl<
                        T: ProjectService,
                    > tonic::server::UnaryService<super::RegisterProjectRequest>
                    for RegisterProjectSvc<T> {
                        type Response = super::RegisterProjectResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                ...
                "/dennett.control.v1.ProjectService/RebindProjectWorkspace" => {
                    #[allow(non_camel_case_types)]
                    struct RebindProjectWorkspaceSvc<T: ProjectService>(pub Arc<T>);
                    impl<
                        T: ProjectService,
                    > tonic::server::UnaryService<super::RebindProjectWorkspaceRequest>
                    for RebindProjectWorkspaceSvc<T> {
                        type Response = super::RebindProjectWorkspaceResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProjectService>::rebind_project_workspace(
                                        &inner,
                                        request,
                                    )
                                    .await
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RebindProjectWorkspaceSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
                ...
                "/dennett.control.v1.ProjectService/SetProjectTrust" => {
                    #[allow(non_camel_case_types)]
                    struct SetProjectTrustSvc<T: ProjectService>(pub Arc<T>);
                    impl<
                        T: ProjectService,
                    > tonic::server::UnaryService<super::SetProjectTrustRequest>
                    for SetProjectTrustSvc<T> {
                        type Response = super::SetProjectTrustResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ProjectService>::set_project_trust(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = SetProjectTrustSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "dennett.control.v1.ProjectService";
...
pub mod session_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SessionService/CreateSession",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SessionService", "CreateSession"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn send_turn(
            &mut self,
            request: impl tonic::IntoRequest<super::SendTurnRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendTurnResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SessionService/SendTurn",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SessionService", "SendTurn"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn cancel_turn(
            ...
            tonic::Response<super::CancelTurnResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SessionService/CancelTurn",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SessionService", "CancelTurn"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        pub async fn watch_session(
            &mut self,
            request: impl tonic::IntoRequest<super::WatchSessionRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WatchSessionResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SessionService/WatchSession",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SessionService", "WatchSession"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
        ///
...
pub mod session_service_server {
    ...
    pub trait SessionService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn send_turn(
            &self,
            request: tonic::Request<super::SendTurnRequest>,
        ) -> std::result::Result<
            tonic::Response<super::SendTurnResponse>,
            tonic::Status,
        >;
        ...
        async fn cancel_turn(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the WatchSession method.
        type WatchSessionStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WatchSessionResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        ///
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/dennett.control.v1.SessionService/SendTurn" => {
                    #[allow(non_camel_case_types)]
                    struct SendTurnSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    > tonic::server::UnaryService<super::SendTurnRequest>
                    for SendTurnSvc<T> {
                        type Response = super::SendTurnResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::send_turn(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/dennett.control.v1.SessionService/CancelTurn" => {
                    #[allow(non_camel_case_types)]
                    struct CancelTurnSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    > tonic::server::UnaryService<super::CancelTurnRequest>
                    for CancelTurnSvc<T> {
                        type Response = super::CancelTurnResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::cancel_turn(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/dennett.control.v1.SessionService/WatchSession" => {
                    #[allow(non_camel_case_types)]
                    struct WatchSessionSvc<T: SessionService>(pub Arc<T>);
                    impl<
                        T: SessionService,
                    > tonic::server::ServerStreamingService<super::WatchSessionRequest>
                    for WatchSessionSvc<T> {
                        type Response = super::WatchSessionResponse;
                        type ResponseStream = T::WatchSessionStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::watch_session(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = WatchSessionSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "dennett.control.v1.SessionService";
...
pub mod system_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SystemService/Handshake",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SystemService", "Handshake"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SystemService/Bootstrap",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SystemService", "Bootstrap"),
                );
            self.inner.unary(req, path, codec).await
        }
        ///
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/dennett.control.v1.SystemService/GetHealth",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("dennett.control.v1.SystemService", "GetHealth"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
...
pub mod system_service_server {
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/dennett.control.v1.SystemService/Handshake" => {
                    #[allow(non_camel_case_types)]
                    struct HandshakeSvc<T: SystemService>(pub Arc<T>);
                    impl<
                        T: SystemService,
                    ...
                    for HandshakeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SystemService>::handshake(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/dennett.control.v1.SystemService/Bootstrap" => {
                    #[allow(non_camel_case_types)]
                    struct BootstrapSvc<T: SystemService>(pub Arc<T>);
                    impl<
                        T: SystemService,
                    ...
                    for BootstrapSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SystemService>::bootstrap(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "dennett.control.v1.SystemService";

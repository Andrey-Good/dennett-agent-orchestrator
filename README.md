...
Stage 13 local support diagnostics are documented in [`docs/21-public-launch-readiness/observability-support-operations.md`](./docs/21-public-launch-readiness/observability-support-operations.md). `support-bundle` emits reviewed local-only redacted JSON, and shareable runtime diagnostics should use `runtime-env-inspect --redacted`. These diagnostics do not create hosted support, SLA, status-page, managed incident-response, automatic telemetry, public npm, signing, or provenance claims.
...
7. For support, diagnostics, telemetry, or local incident handling, read [`docs/21-public-launch-readiness/observability-support-operations.md`](./docs/21-public-launch-readiness/observability-support-operations.md) before sharing logs or claiming support readiness.

# Участие в разработке Denet

Denet развивается от спецификации к реализации. Изменения должны сохранять связь между намерением продукта, бизнес-логикой, архитектурой, кодом и тестами.

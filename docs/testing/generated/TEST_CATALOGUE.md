...
- Status: `automated` 11, `specified` 4
- Risk: `R1` 7, `R2` 5, `R3` 3
...
| `TEST-MILESTONE-CURRENT-LABEL-001` | Generated milestone plan reports the actual current lifecycle state | `planning`, `testing` | `R1` | `specified` | `high` | `quality` | `planned` |

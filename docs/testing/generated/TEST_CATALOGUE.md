...
- Status: `automated` 12, `specified` 4
- Risk: `R1` 8, `R2` 5, `R3` 3
...
| `TEST-MILESTONE-ACCEPTED-HANDOFF-001` | Generated milestone plan supports the accepted-milestone handoff | `planning`, `testing` | `R1` | `specified` | `critical` | `quality` | `planned` |

...
| `ARCH-83:TauriBridge` | `TEST-TAURI-WATCH-BRIDGE-001` | `WP-M01-006` | `desktop` | `apps/desktop/src-tauri/src/system_bridge/dto.rs`, `apps/desktop/src-tauri/src/system_bridge/mod.rs`, `apps/desktop/src/lib/systemBridge.test.ts` | `release` |
| `ARCH-83:WatchReducer` | `TEST-TAURI-WATCH-BRIDGE-001` | `WP-M01-006` | `desktop` | `apps/desktop/src-tauri/src/system_bridge/dto.rs`, `apps/desktop/src-tauri/src/system_bridge/mod.rs`, `apps/desktop/src/lib/systemBridge.test.ts` | `release` |

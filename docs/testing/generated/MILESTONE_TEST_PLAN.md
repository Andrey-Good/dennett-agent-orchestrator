...
Current milestone: `M01` — Local desktop conversation (status: `QUALIFYING`).

- Package status: `MERGED` 7
...
| `WP-M01-007` | `MERGED` | `TEST-DESKTOP-DRAFT-RECOVERY-001` | `R2` | `automated` | `desktop` |
| `WP-M01-007` | `MERGED` | `TEST-M01-DESKTOP-CONVERSATION-E2E-001` | `R2` | `manual` | `quality` |
| `WP-M01-007` | `MERGED` | `TEST-M01-PROVIDER-TIMEOUT-VISIBLE-001` | `R2` | `automated` | `quality` |
| `WP-M01-007` | `MERGED` | `TEST-M01-TRACE-CORRELATION-001` | `R2` | `automated` | `observability` |

...
- Package status: `MERGED` 4, `MERGE_READY` 1, `REFINED` 2
...
| `WP-M01-003` | `MERGE_READY` | `TEST-DESKTOP-PROJECT-CHAT-A11Y-001` | `R2` | `automated` | `desktop` |
| `WP-M01-003` | `MERGE_READY` | `TEST-DESKTOP-PROJECT-CHAT-UI-001` | `R2` | `automated` | `desktop` |

...
- Package status: `IN_PROGRESS` 1, `MERGED` 5, `REFINED` 1
...
| `WP-M01-006` | `IN_PROGRESS` | `TEST-DESKTOP-NODE-LIFECYCLE-001` | `R2` | `automated` | `desktop` |
| `WP-M01-006` | `IN_PROGRESS` | `TEST-LOCAL-IPC-HANDSHAKE-001` | `R2` | `automated` | `transport` |
| `WP-M01-006` | `IN_PROGRESS` | `TEST-TAURI-WATCH-BRIDGE-001` | `R2` | `automated` | `desktop` |

...
- Package status: `IN_PROGRESS` 1, `MERGED` 2, `REFINED` 6
...
| `WP-M02-003` | `IN_PROGRESS` | `TEST-M02-INSTRUCTION-CHANGE-001` | `R3` | `specified` | `projects` |
| `WP-M02-003` | `IN_PROGRESS` | `TEST-M02-PROJECT-CREATE-IMPORT-001` | `R3` | `specified` | `projects` |
| `WP-M02-003` | `IN_PROGRESS` | `TEST-M02-PROJECT-MISSING-001` | `R2` | `specified` | `projects` |
| `WP-M02-003` | `IN_PROGRESS` | `TEST-M02-PROJECT-TRUST-001` | `R3` | `specified` | `trust` |

# Dennett Test Catalogue and Quality Gates
...
Dennett действительно потребует порядка **850–1200 заранее специфицированных тестовых случаев** до выхода зрелой beta, а реальных исполняемых tests будет несколько тысяч за счёт unit/property/generated вариантов.
